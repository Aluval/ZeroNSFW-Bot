...
async def start(app, msg: Message):
    ...
    if joined_channel_1.get(user_id, False) and joined_channel_2.get(user_id, False):
        ...
        await app.send_photo(
            ...
            caption=start_text,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("Developer 🛡️", url="https://t.me/ZeroNSFW_Admin"),
                 InlineKeyboardButton("Updates 📢", url="https://t.me/ZeroNSFW_Updates")],
                [InlineKeyboardButton("Help 🌟", callback_data="help"),
                 InlineKeyboardButton("About 🧑🏻‍💻", callback_data="about")],
                [InlineKeyboardButton("Support ❤️‍🔥", url="https://t.me/ZeroNSFW_Support")]
            ]),
...
async def about_callback(app, msg):
    ...
    txt += "<b>🧑🏻‍💻 Developer: <a href='https://t.me/ZeroNSFW_Admin'>ZeroNSFW Team</a></b>\n"     
    txt += "<b>📢 Updates: <a href='https://t.me/ZeroNSFW_Updates'>ZeroNSFW Network</a></b>\n"
    txt += "<b>✨ Support: <a href='https://t.me/ZeroNSFW_Support'>ZeroNSFW Helpdesk</a></b>\n"
